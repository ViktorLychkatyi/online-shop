            ...
            <div className={"w-2xs height=[465px] bg-white rounded-2xl p-2 flex flex-col gap-2"}>
                ...
                <div className={"flex flex-col items-start gap-1"}>
                    <div className={"flex flex-row gap-5"}>
                        ...
                        <div className={"flex flex-row gap-1 w-full"}><img src="svg/Frame 15.svg" alt=""/>0 отзывов</div></div>
                    <div className={"flex"}></div>
                <div className={"flex flex-row items-center gap-1"}>
                    <p className={"text-2xl font-semibold"}>15 000 грн</p>
                    <p className={"text-sm font-medium relative top-0.5"}>25 000 грн</p>
                </div>
                    <button className={"w-full bg-tiny text-white text-xl font-semibold p-3 rounded-4xl mt-1"}>В корзину</button>
                </div>
            </div>
        </>
    )
