export function FormOrder() {
    return (
        <>
            <form action="" className="container flex flex-col p-4 gap-4 bg-white ">
                ...
                <div className="flex flex-row gap-4">
                    <input type="text" placeholder="Номер карты" className="border border-gray rounded-4xl p-4 focus:outline-none focus:border-tiny focus:ring-1 focus:ring-tiny"/>
                    <input type="text" placeholder="mm / yy" className="border border-gray rounded-4xl p-4 focus:outline-none focus:border-tiny focus:ring-1 focus:ring-tiny"/>
                    <input type="text" placeholder="mm / yy" className="border border-gray rounded-4xl p-4 focus:outline-none focus:border-tiny focus:ring-1 focus:ring-tiny"/>
                </div>
            </form>
        </>
